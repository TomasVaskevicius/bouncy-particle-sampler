...
class Mcmc : public RandomNumberSampler<FloatingPointType, Dimensionality> {
 ...
 public:
  ...
  /**
   * Returns a vector of McmcState objects generated by derived classes
   * implementing mcmc algorithms.
   */
  SampleOutput getBatchOfMcmcStates(int batchSize);
  ...
  std::shared_ptr<McmcState<FloatingPointType, Dimensionality>> lastState_;
